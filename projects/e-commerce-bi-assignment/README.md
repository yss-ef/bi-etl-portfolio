# PROJET BI : ANALYSE E-COMMERCE (Sujet d'Examen)
...
![Chargement Dimension Client](docs/img/01_etl_dimension_client.png)
...
![Transformation Table de Faits](docs/img/02_etl_fait_commande.png)
...
![Dashboard Metabase Page 1](docs/img/03_dashboard_vue_globale.png)
...
![Dashboard Metabase Page 2](docs/img/04_dashboard_analyse_produit.png)

### 5.3 Qualité Logistique (Page 3)
Point critique : **29% de taux de retard**. Les transporteurs ont un retard moyen de ~0,6 jour.

![Dashboard Metabase Page 3](docs/img/05_dashboard_logistique.png)
...
```text
devoir-bi/
├── README.md             # Rapport complet (ce fichier)
├── data/                 # Fichiers sources (CSV)
├── etl/                  # Flux Pentaho (KTR et KJB)
├── sql/                  # Scripts de création de la base de données
└── docs/                 # Documentations et annexes
